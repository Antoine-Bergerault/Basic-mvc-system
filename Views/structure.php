...
<?php require_once('header.php') ?>
    ...
    <p>Some functions useful functions accessible from anywhere are saved in <span class="path">Tools/function.php</span>.</p>
    ...
    <ul id="structure">
        <li><h4>App</h4>
            <ul>
                <li><h5>App.php</h5></li>
                <li><h5>Cache.php</h5></li>
                <li><h5>Email.php</h5></li>
                <li><h5>Extras.php</h5></li>
            </ul>
        </li>
